...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<ProductAdet> ProductAdets { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        .UseSqlServer("Data Source=(localdb)\\mertcan;Initial Catalog=Northwind;Integrated Security=SSPI;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ProductAdet>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ProductAdet");
